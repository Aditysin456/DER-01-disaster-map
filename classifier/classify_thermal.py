...
def classify_thermal(image_bytes):
    ...
    # count_confident: False when MobileNet says humans are present but
    # YOLO could not confidently localize/count any of them. In that case
    # human_count_estimate is a floor, not an exact count.
    count_confident = not (humans_detected and human_count == 0)
    ...
    return {
        ...
        "count_confident": count_confident,
